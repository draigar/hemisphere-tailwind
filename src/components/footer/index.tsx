    ...
    return (
        <footer className=" text-center lg:text-left bg-gray-100 text-gray-600 px-8 py-8">
          ...
          ">
                        ...
                        <p className="w-4/5">
                            Hemisphere Technologies is a green tech company aiming to create a positive change for the planet by producing carbon negative products made by industrial hemp.
                        </p>
                    </div>
                    <div className="">
            ...
            <div className="p-6">
                <span>Hemisphere Technologies 2021</span>
            </div>
        </footer>
    );
};
